...
\newcommand{\myname}{Wang Jing}
\newcommand{\myemail}{wangjing@s.okayama-u.ac.jp}
\newcommand{\myhwtype}{Homework}
\newcommand{\myhwnum}{1-3}
\newcommand{\myclass}{Material Science}
...
\begin{namedquestion}{Name of the question}
